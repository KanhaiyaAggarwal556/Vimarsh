...
export interface BatchInteractionResponse {
  [postId: string]: PostInteraction & { error?: string };
}
...
class PostInteractionAPI {
  ...
  async toggleLike(postId: string): Promise<PostInteractionResponse> {
    ...
    return this.makeRequest<PostInteractionResponse>(`${this.baseURL}/${postId}/like`, {
      method: 'POST',
    });
  }
  ...
  async toggleDislike(postId: string): Promise<PostInteractionResponse> {
    ...
    return this.makeRequest<PostInteractionResponse>(`${this.baseURL}/${postId}/dislike`, {
      method: 'POST',
    });
  }
  ...
  async getUserInteraction(postId: string): Promise<PostInteractionResponse> {
    ...
    return this.makeRequest<PostInteractionResponse>(`${this.baseURL}/${postId}/status`);
  }

  async getBatchInteractions(postIds: string[]): Promise<BatchInteractionResponse> {
