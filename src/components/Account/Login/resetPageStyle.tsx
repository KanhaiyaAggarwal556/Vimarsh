...
// Type definitions for CSS properties with media queries
interface MediaQueryStyles {
  [key: string]: string | number;
}

interface StyleWithMediaQueries {
  [key: string]: string | number | MediaQueryStyles;
}

interface Styles {
  [key: string]: StyleWithMediaQueries;
}
...
// Helper function to apply responsive styles with proper typing
export const getResponsiveStyles = (baseStyles: Styles): Styles => {
  const processedStyles: Styles = {};
  
  Object.keys(baseStyles).forEach((key: string) => {
...
// CSS keyframes for animations (add these to your global CSS)
